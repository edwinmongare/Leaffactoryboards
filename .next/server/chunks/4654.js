...
const DegredationV2 = ()=>{
    const { 0: displayDegred2 , 1: setDisplayDegred2  } = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(false);
    ...
    const formikMoistures = (0,formik__WEBPACK_IMPORTED_MODULE_7__.useFormik)({
        ...
        onSubmit: async (values, { setSubmitting , resetForm  })=>{
            try {
                ...
                const response = await axios__WEBPACK_IMPORTED_MODULE_9__["default"].post(`${_apiConfig__WEBPACK_IMPORTED_MODULE_11__/* .apiDevUrl */ .f}postDegredationv2`, values);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (DegredationV2);
