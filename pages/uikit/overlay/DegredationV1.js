 ...
 const formikMoistures = useFormik({
  ...
  onSubmit: async (values, { setSubmitting, resetForm }) => {
   try {
    ...
    const response = await axios.post(`${apiDevUrl}postDegredationv1`, values);
 ...
 return (
  <>
   ...
   <div className="card shadow-3">
    <h6 className="font-bold">Conditioning Moistures </h6>
      ...
      <div className="grid">
       <div className="col-12 md:col-12">
        <div className="card p-fluid">
         ...
         <label htmlFor="Q1">EXIT 1st CC</label>
         <div className="field">
          <InputText
           id="Q1"
           name="Q1"
         ...
         <div className="field">
          <label htmlFor="Q2">TEMP_1st_CC</label>
          <InputText
           id="Q2"
           name="Q2"
         ...
         <div className="field">
          <label htmlFor="Q3">EXIT_2nd_CC</label>
          <InputText
           id="Q3"
           name="Q3"
         ...
         <div className="field">
          <label htmlFor="Q4">TEMP_2nd_CC</label>
          <InputText
           id="Q4"
           name="Q4"
